...
<%@tag description="Client page tag" %>
                ...
                <div class="login-form">
                    ...
                    <table class="login-table">
                        <tr>
                            ...
                            <td>Nickname: <form:input path="nickName"/></td>
                            <td>Password: <form:input path="password"/></td>
                            <td><button type="submit" class="btn btn-primary">Log in</button></td>
                            </form:form>
                            <td><a href="<c:url value="/register"/>"><button class="btn btn-success">Register</button></a></td>
                        </tr>
                    </table>
                </div>
            </li>
